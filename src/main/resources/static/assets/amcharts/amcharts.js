        ...
        if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) c = !0; else {
            ...
            if (0 < e) {
                ...
                for (f = this.fillAlpha = 0; f < e; f++) {
                    ...
                    var z = NaN;
                    isNaN(x.value) || (z = this.getCoordinate(x.value), v = new this.axisItemRenderer(this, z, x.label, !0, NaN, (F - z) / 2, x), this.pushAxisItem(v, B));
            ...
            var s = this.step, I, t = this.minorGridAlpha;
            ...
            for (f = p; f < q; f += n) if (p = s * f + this.min, d && this.max - this.min > 5 * this.min && (p -= this.min), p = AmCharts.roundTo(p, this.maxDecCount + 1), !this.integersOnly || Math.round(p) == p) if (isNaN(w) || Number(AmCharts.toFixed(p, w)) == p) {
                ...
                v = new this.axisItemRenderer(this, e, v, void 0, void 0, void 0, void 0, this.boldLabels);
                this.pushAxisItem(v);
...
AmCharts.RecItem = AmCharts.Class({
    construct: function (a, b, c, d, e, f, g, h, k, l, m) {
        ...
        var V = a.counter, T = a.inside, fa = a.labelOffset, aa = a.dx, ga = a.dy, Na = a.orientation, ma = a.position,
            ba = a.previousCoord, Q = a.viH, X = a.viW, na = a.offset, $, W;
        g ? (H = !0, isNaN(g.tickLength) || (u = g.tickLength), void 0 != g.lineColor && (B = g.lineColor), void 0 != g.color && (q = g.color), isNaN(g.lineAlpha) || (x = g.lineAlpha), isNaN(g.dashLength) || (z = g.dashLength), isNaN(g.lineThickness) || (F = g.lineThickness), !0 === g.inside && (T = !0), isNaN(g.labelRotation) || (m = g.labelRotation), isNaN(g.fontSize) || (p = g.fontSize), g.position && (ma = g.position), void 0 !== g.boldLabel && (h = g.boldLabel), isNaN(g.labelOffset) || (fa = g.labelOffset)) : "" === c && (u = 0);
        W = "start";
        e && (W = "middle");
...
AmCharts.AmGraph = AmCharts.Class({
    construct: function (a) {
        ...
        var l = this.useNegativeColorIfDown, m = this.width, n = this.height, p = this.y, q = this.rotate,
            r = this.columnCount, s = AmCharts.toCoordinate(this.cornerRadiusTop, h / 2), w = this.connect, v = [],
            t = [], u, x, F, B, z = this.chart.graphs.length, I, E = this.dx / this.tcc, H = this.dy / this.tcc,
            V = f.stackType, T = this.start, fa = this.end, aa = this.scrollbar, ga = this.categoryAxis,
            Na = this.baseCoord, ma = this.negativeBase, ba = this.columnIndex, Q = this.lineThickness,
            X = this.lineAlpha, na = this.lineColorR, $ = this.dashLength, W = this.set, Y, ja = this.getGradRotation(),
        ...
        if (!(aa || "line" != g && "smoothedLine" != g && "step" != g || (1 == d.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Da && void 0 == wa || l))) {
            ...
            q ? (eb = n, fb = Math.abs(Cb - Aa), hb = n, ib = Math.abs(Za - Aa), Ya = gb = 0, f.reversed ? (Wa = 0, Xa = Aa) : (Wa = Aa, Xa = 0)) : (fb = m, eb = Math.abs(Cb - Aa), ib = m, hb = Math.abs(Za - Aa), Xa = Wa = 0, f.reversed ? (Ya = p, gb = Aa) : Ya = Aa + 1)
        }
        var Ba = Math.round;
        this.pmx = Ba(Wa);
        this.pmy = Ba(gb);
        ...
        for (J = T; J <= fa; J++) {
            ...
            var R, P, L, ca, ha = NaN, D = NaN, C = NaN, M = NaN, K = NaN, Ha = NaN, xa = NaN, Ia = NaN, ya = NaN,
            ...
            if (va) {
                ...
                var ha = S.x[ga.id], La = this.periodSpan - 1, la = Math.floor(A / 2) + Math.floor(La * A / 2), za = la,
                    cb = 0;
                ...
                -1E5 > ha && (ha = -1E5);
                ha > m + 1E5 && (ha = m + 1E5);
                q ? (D = C, M = K, K = C = ha, isNaN(ia) && !this.fillToGraph && (M = Na), Ha = xa, Ia = ya) : (M = D = ha, isNaN(ia) && !this.fillToGraph && (K = Na));
                ...
                switch (g) {
                    case"line":
                        if (isNaN(U)) w || (this.drawLineGraph(v, t, N, O), v = [], t = [], N = [], O = []); else {
                            ...
                            if (Qa || void 0 != y.lineColor || void 0 != y.fillColors || !isNaN(y.dashLength)) this.drawLineGraph(v, t, N, O), v = [D], t = [C], N = [], O = [], !Ea || isNaN(K) || isNaN(M) || (N.push(M), O.push(K)), l ? Fa ? (this.lineColorSwitched = na, this.fillColorsSwitched = jb) : (this.lineColorSwitched = wa, this.fillColorsSwitched = Da) : (this.lineColorSwitched = y.lineColor, this.fillColorsSwitched = y.fillColors), this.dashLengthSwitched = y.dashLength;
                            y.gap && (this.drawLineGraph(v, t, N, O), v = [], t = [], N = [], O = [])
                        }
                        break;
                    case"smoothedLine":
                        if (isNaN(U)) w || (this.drawSmoothedGraph(v, t, N, O), v = [], t = [], N = [], O = []); else {
                            if (Math.abs(D - $a) >= bb || Math.abs(C - ab) >= bb) v.push(D), t.push(C), $a = D, ab = C;
                            sa = D;
                            ta = C;
                            da = D;
                    ...
                    case"step":
                        if (!isNaN(U)) {
                            if (void 0 == y.lineColor && void 0 == y.fillColors && isNaN(y.dashLength) || (this.drawLineGraph(v, t, N, O), v = [], t = [], N = [], O = [], this.lineColorSwitched = y.lineColor, this.fillColorsSwitched = y.fillColors, this.dashLengthSwitched = y.dashLength), q ? (isNaN(u) || (v.push(u), t.push(C - la)), t.push(C - la), v.push(D), t.push(C + za), v.push(D), !Ea || isNaN(K) || isNaN(M) || (N.push(F), O.push(K - la), N.push(M), O.push(K - la), N.push(M), O.push(K + za))) : (isNaN(x) || (t.push(x), v.push(u), t.push(x), v.push(D - la)), v.push(D - la), t.push(C), v.push(D + za), t.push(C), !Ea || isNaN(K) || isNaN(M) || (N.push(M - la), O.push(B), N.push(M - la), O.push(K), N.push(M + za), O.push(K))), u = D, x = C, F = M, B = K, sa = D, ta = C, da = D, ea = C, Qa && (this.drawLineGraph(v, t, N, O), v = [], t = [], N = [], O = [], l && (Fa ? (this.lineColorSwitched = na, this.fillColorsSwitched = jb) : (this.lineColorSwitched = wa, this.fillColorsSwitched = Da))), Db || y.gap) u = x = NaN, this.drawLineGraph(v, t, N, O), v = [], t = [], N = [], O = []
                        } else if (!w) {
                    ...
                    case"column":
                        ...
                        if (!isNaN(U)) {
                            ...
                            if (qa && (ra = qa.set, y.columnGraphics = ra, ra.translate(R, P), this.columnsSet.push(ra), (y.url || this.showHandOnHover) && ra.setAttr("cursor", "pointer"), !aa)) {
                                ...
                                "3d" == V && (q ? (I = (this.end + 1 - J) * z - c - 1E3 * this.depthCount, sa += E * this.columnIndex, da += E * this.columnIndex, y.y += E * this.columnIndex) : (I = (z - c) * (J + 1) + 1E3 * this.depthCount, ta += H * this.columnIndex, ea += H * this.columnIndex, y.y += H * this.columnIndex));
                    ...
                    case"candlestick":
                        if (!isNaN(ia) && !isNaN(U)) {
                            ...
                            void 0 != y.lineColor && (oa = y.lineColor);
                            if (q) {
                                if (P = C - h / 2, R = M, L = h, P + L > n && (L = n - P), 0 > P && (L += P, P = 0), P < n && 0 < L) {
                                    var qb, rb;
                                ...
                                !isNaN(ya) && !isNaN(xa) && D < m && 0 < D && (db = AmCharts.line(e, [D, D], sb, oa, X, Q), pb = AmCharts.line(e, [D, D], tb, oa, X, Q))
                            }
                        ...
                        if (!(isNaN(ia) || isNaN(lb) || isNaN(mb) || isNaN(U))) {
                            ...
                            if (q) {
                                var xb = C - h / 2, xb = AmCharts.fitToBounds(xb, 0, n),
                                    Hb = AmCharts.fitToBounds(C, 0, n), yb = C + h / 2,
                                ...
                                var zb = D - h / 2, zb = AmCharts.fitToBounds(zb, 0, m),
                                    Ib = AmCharts.fitToBounds(D, 0, m), Ab = D + h / 2,
                ...
                if (!aa && !isNaN(U)) {
                    ...
                    if (this.end - this.start <= Jb || 0 === Jb) {
                        ...
                        if (Kb) {
                            ...
                            (Bb = this.positionLabel(sa, ta, Bb, Sb, L, ca)) && this.allBullets.push(Bb)
                        }
                        if ("regular" == V || "100%" == V) {
                            var Lb = f.totalText;
                            if (Lb) {
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g) "smoothedLine" == g ? this.drawSmoothedGraph(v, t, N, O) : this.drawLineGraph(v, t, N, O), aa || this.launchAnimation();
        ...
        if (1 < a.length) {
            ...
            var k = this.lineAlpha, l = this.lineThickness, e = this.dashLength, m = this.fillAlphas,
                ...
                s = this.negativeFillAlphas, w = this.baseCoord, v = this.lineColorSwitched;
            v && (n = v);
        ...
        if (this.enabled) {
            ...
            if (q) {
                ...
                if (c.mouseIsOver || F || B || this.forceShow) if (this.forceShow = !1, B) {
                    ...
                    b ? (h = {type: "changed"}, h.index = a, h.chart = this.chart, h.zooming = F, h.mostCloseGraph = I, h.position = s ? f : e, h.target = this, c.fire("changed", h), this.fire("changed", h), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
    ...
    construct: function (a) {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                "H" != v ? (B = a - z / 2, b < h + u + 10 && "down" != v ? (I = !0, d && (b += x), x = b + w, this.deltaSignY = -1) : (d && (b -= x), x = b - u - w, this.deltaSignY = 1)) : (2 * w > u && (w = u / 2), x = b - u / 2, a < g + (k - g) / 2 ? (B = a + w, this.deltaSignX = -1) : (B = a - z - w, this.deltaSignX = 1));
                x + u >= l && (x = l - u);
                x < h && (x = h);
                B < g && (B = g);
                B + z > k && (B = k - z);
                var h = x + s, l = B + r, s = this.shadowAlpha, E = this.shadowColor, r = this.borderThickness,
                    H = this.bulletSize, V;
                0 < t || 0 === w ? (0 < s && (a = AmCharts.rect(e, z, u, n, 0, r + 1, E, s, this.cornerRadius), AmCharts.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), n = AmCharts.rect(e, z, u, n, this.fillAlpha, r, p, this.borderAlpha, this.cornerRadius), this.showBullet && (V = AmCharts.circle(e, H, q, this.fillAlpha), f.push(V))) : (q = [], t = [], "H" != v ? (g = a - B, g > z - w && (g = z - w), g < w && (g = w), q = [0, g - w, a - B, g + w, z, z, 0, 0], t = I ? [0, 0, b - x, 0, 0, u, u, 0] : [u, u, b - x, u, u, 0, 0, u]) : (q = b - x, q > u - w && (q = u - w), q < w && (q = w), t = [0, q - w, b - x, q + w, u, u, 0, 0], q = a < g + (k - g) / 2 ? [0, 0, B < a ? 0 : a - B, 0, 0, z, z, 0] : [z, z, B + z > a ? z : a - B, z, z, 0, 0, z]), 0 < s && (a = AmCharts.polygon(e, q, t, n, 0, r, E, s), a.translate(1, 1), f.push(a)), n = AmCharts.polygon(e, q, t, n, this.fillAlpha, r, p, this.borderAlpha));
                this.bg = n;
                f.push(n);
                n.toFront();
                e = 1 * this.deltaSignX;
                ...
                0 < this.animationDuration && !d && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY), f.animate({translate: B - e + "," + x}, b, "easeOutSine"), m && (F.left = this.prevTX + "px", F.top = this.prevTY + "px", this.xAnim = c.animate({node: m}, "left", this.prevTX, l, b, "easeOutSine", "px"), this.yAnim = c.animate({node: m}, "top", this.prevTY, h, b, "easeOutSine", "px")));
                this.prevX = B - e;
                this.prevY = x;
                this.prevTX = l;
                this.prevTY = h
...
AmCharts.TrendLine = AmCharts.Class({
    construct: function (a) {
        ...
        var b = a.chart, c = b.container, d, e, f, g, h = a.categoryAxis, k = a.initialDate, l = a.initialCategory,
            ...
            s = a.finalXValue, w = a.initialValue, v = a.finalValue, t = p.recalculateToPercents, u = b.dataDateFormat;
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    0 < k && (H = " M" + s + "," + (v + k) + " L" + t + "," + (u + k), r ? (E || (H += " A" + (b - f) + "," + (k + c - g) + "," + (b + f) + "," + (k + c + g) + "," + t + "," + (u + k) + "," + x + "," + (F + k)), H += " L" + B + "," + (w + k), 0 < h && (E || (H += " B" + (b - h) + "," + (k + c - q) + "," + (b + h) + "," + (k + c + q) + "," + B + "," + (k + w) + "," + s + "," + (k + v)))) : (H += " A" + f + "," + g + ",0," + I + ",1," + x + "," + (F + k) + " L" + B + "," + (w + k), 0 < h && (H += " A" + h + "," + q + ",0," + I + ",0," + s + "," + (v + k))), H = a.path(H + " Z", void 0, void 0, "1000,1000").attr(z), d.push(H), H = a.path(" M" + s + "," + v + " L" + s + "," + (v + k) + " L" + t + "," + (u + k) + " L" + t + "," + u + " L" + s + "," + v + " Z", void 0, void 0, "1000,1000").attr(z), k = a.path(" M" + x + "," + F + " L" + x + "," + (F + k) + " L" + B + "," + (w + k) + " L" + B + "," + w + " L" + x + "," + F + " Z", void 0, void 0, "1000,1000").attr(z), d.push(H), d.push(k));
    r ? (E || (e = " A" + p(b - f) + "," + p(c - g) + "," + p(b + f) + "," + p(c + g) + "," + p(t) + "," + p(u) + "," + p(x) + "," + p(F)), f = " M" + p(s) + "," + p(v) + " L" + p(t) + "," + p(u) + e + " L" + p(B) + "," + p(w)) : f = " M" + s + "," + v + " L" + t + "," + u + (" A" + f + "," + g + ",0," + I + ",1," + x + "," + F) + " L" + B + "," + w;
...
AmCharts.AmLegend = AmCharts.Class({
    construct: function (a) {
        ...
        this.titleWidth = 0;
        if (e = this.title) a = AmCharts.text(this.container, e, this.color, a.fontFamily, this.fontSize, "start", !0), a.translate(this.marginLeft, this.marginTop + this.verticalGap + this.ly + 1), a = a.getBBox(), this.titleWidth = a.width + 15, this.titleHeight = a.height + 6;
