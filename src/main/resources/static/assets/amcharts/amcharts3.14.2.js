...
(function () {
    ...
    d.parseDefs = function (a, b) {
        for (var c in a) {
            var e = typeof a[c];
            if (0 < a[c].length && "object" == e) for (var h = 0; h < a[c].length; h++) e = document.createElementNS(d.SVG_NS, c), b.appendChild(e),
                d.parseDefs(a[c][h], e); else "object" == e ? (e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c], e)) : b.setAttribute(c, a[c])
        }
    }
})();
(function () {
    ...
    d.AxisBase = d.Class({
        construct: function (a) {
            ...
            var u, z = this.gridAlpha, v,
                w = this.choosePeriod(0), x = w.period, w = w.count, A = d.getPeriodDuration(x, w);
            ...
            if (0 < this.gridCountR) for (a = k; a <= B; a++) {
                ...
                this.pushAxisItem(m);
                m = l = p;
                if (!isNaN(u)) for (h = 1; h < w; h += u) this.gridAlpha =
                    this.minorGridAlpha, f = p + v * h, f = d.resetDateToMin(new Date(f), x, u, r).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth), this.pushAxisItem(f);
                this.gridAlpha = z
            }
    ...
    d.ValueAxis = d.Class({
        inherits: d.AxisBase, construct: function (a) {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) e = !0; else {
                ...
                var v, w = this.guides, x = w.length;
                if (0 < x) {
                    var A = this.fillAlpha;
                    for (g = this.fillAlpha = 0; g < x; g++) {
                        var B = w[g], D = NaN, C = B.above;
...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            void 0 == u && (u = p.color);
            void 0 !== n && (u = n);
            var z = a.chart.container, v = z.set();
            this.set = v;
            var w = a.axisThickness, x = a.axisColor, A = a.axisAlpha, B = a.tickLength, D = a.gridAlpha,
            ...
            if ("H" == Pa) {
                if (0 <= b && b <= sa + 1 && (0 < B && 0 < A && b + l <= sa + 1 && (ca = d.line(z, [b + l, b + l], [0, B], x, A, C), v.push(ca)), 0 < D && (ta = d.line(z,
                ...
                V + 1 && (ca = d.line(z, [0, B], [b + l, b + l], x, A, C), v.push(ca)), 0 < D && (ta = d.line(z, [0, qa, sa + qa], [b, b + ja, b + ja], I, D, C, H), v.push(ta)));
                ia = "end";
    ...
    d.AmChart = d.Class({
        construct: function (a) {
            ...
            if (d.ifArray(a)) {
                ...
                for (c = 0; c < a.length; c++) {
                    var e = a[c], e = d.processObject(e, d.Title,
                        this.theme);
                    if (!1 !== e.enabled) {
                        var h = e.color;
        ...
        inIframe: function () {
            ...
            if ("amcharts.com" != b || !0 === this.inIframe()) {
                ...
                var g = "", k = "", l = "";
                "ammap" == this.product && (g = "http://www.ammap.com/javascript-maps/", k = "Interactive JavaScript maps", l = "");
    ...
    d.AmGraph = d.Class({
        construct: function (a) {
            ...
            var m = this.useNegativeColorIfDown, n = this.width, q = this.height, p = this.y, r = this.rotate,
                t = this.columnCount, u = d.toCoordinate(this.cornerRadiusTop, k / 2), z = this.connect, v = [], w = [],
                x, A, B, D, C = this.chart.graphs.length, I, H = this.dx / this.tcc, O = this.dy / this.tcc,
            ...
            for (K = da; K <= pa; K++) {
                ...
                if (Ba) {
                    ...
                    switch (g) {
                        case "line":
                            if (isNaN(X)) z || (this.drawLineGraph(v, w, R, S), v = [], w = [], R = [], S = []); else {
                                ...
                                if (Ya || void 0 != y.lineColor || void 0 != y.fillColors || !isNaN(y.dashLength)) this.drawLineGraph(v,
                                    w, R, S), v = [F], w = [E], R = [], S = [], !Ka || isNaN(L) || isNaN(N) || (R.push(N), S.push(L)), m ? La ? (this.lineColorSwitched = sa, this.fillColorsSwitched = tb) : (this.lineColorSwitched = Ca, this.fillColorsSwitched = Ja) : (this.lineColorSwitched = y.lineColor, this.fillColorsSwitched = y.fillColors), this.dashLengthSwitched = y.dashLength;
                                y.gap && (this.drawLineGraph(v, w, R, S), v = [], w = [], R = [], S = [])
                            }
                            break;
                        case "smoothedLine":
                            if (isNaN(X)) z || (this.drawSmoothedGraph(v, w, R, S), v = [], w = [], R = [], S = []); else {
                                if (Math.abs(F - hb) >= jb || Math.abs(E - ib) >= jb) v.push(F),
                                    w.push(E), hb = F, ib = E;
                                ya = F;
                                za = E;
                                ga = F;
                        ...
                        case "step":
                            if (!isNaN(X)) {
                                ...
                                if (Ya || void 0 != y.lineColor || void 0 != y.fillColors || !isNaN(y.dashLength)) {
                                    var Yb = v[v.length - 2], Zb = w[w.length - 2];
                                    v.pop();
                                    w.pop();
        ...
        animateColumns: function (a, b) {
            ...
            if (1 < a.length) {
                ...
                var u = h.negativeLineColor, v = h.negativeFillColors, w = h.negativeFillAlphas, x = h.baseCoord;
                ...
                if (0 < f || 0 < w) if (q = a.join(";").split(";"), r = b.join(";").split(";"), n = g.type, "serial" == n ? 0 < c.length ? (c.reverse(), e.reverse(), q = a.concat(c), r = b.concat(e)) : h.rotate ? (r.push(r[r.length - 1]), q.push(x), r.push(r[0]), q.push(x), r.push(r[0]), q.push(q[0])) : (q.push(q[q.length - 1]), r.push(x), q.push(q[0]), r.push(x), q.push(a[0]), r.push(r[0])) : "xy" == n && (b = h.fillToAxis) && (d.isString(b) &&
                (b = g.getValueAxisById(b)), "H" == b.orientation ? (x = "top" == b.position ? 0 : b.viH, q.push(q[q.length - 1]), r.push(x), q.push(q[0]), r.push(x), q.push(a[0]), r.push(r[0])) : (x = "left" == b.position ? 0 : b.viW, r.push(r[r.length - 1]), q.push(x), r.push(r[0]), q.push(x), r.push(r[0]), q.push(q[0]))), a = h.gradientRotation, 0 < f && (b = d.polygon(k, q, r, t, f, 1, "#000", 0, a), b.pattern(h.pattern, NaN, g.path), d.setCN(g, b, h.bcn + "fill"), l.push(b)), v || void 0 !== u) isNaN(w) && (w = f), v || (v = u), k = d.polygon(k, q, r, v, w, 1, "#000", 0, a), d.setCN(g, k, h.bcn + "fill"),
                    d.setCN(g, k, h.bcn + "fill-negative"), k.pattern(h.pattern, NaN, g.path), m.push(k), m.click(function (a) {
                    h.handleGraphEvent(a, "clickGraph")
                }).mouseover(function (a) {
                    h.handleGraphEvent(a, "rollOverGraph")
                }).mouseout(function (a) {
            ...
            if (1 < a.length) {
                var h = this.set, f = this.chart, g = this.container,
                    k = g.set(), l = g.set();
                h.push(l);
                h.push(k);
                var m = this.lineAlpha, n = this.lineThickness, h = this.dashLength, q = this.fillAlphas,
                    ...
                    z = this.negativeFillAlphas, v = this.baseCoord, w = this.lineColorSwitched;
                w && (p = w);
                ...
                k.push(m.path);
                void 0 !== t && (n = new d.Bezier(g, a, b, t, w, n, r, 0, h), d.setCN(f, n, this.bcn +
                    "stroke"), d.setCN(f, n, this.bcn + "stroke-negative"), l.push(n.path));
                ...
                (u = t), a = new d.Bezier(g, a, b, NaN, 0, 0, u, z, h, n), a.path.pattern(this.pattern, NaN, f.path), d.setCN(f, a, this.bcn + "fill"), d.setCN(f, a, this.bcn + "fill-negative"), l.push(a.path));
                this.applyMask(l, k)
            }
        ...
        showCustomBullets: function () {
            ...
            if (a) {
                ...
                e = this.showBalloon;
                !c.chartCursor || "serial" != c.type && "gantt" != c.type || (e =
                    !1, !c.chartCursor.valueBalloonsEnabled && this.showBalloon && (e = !0));
                if (e) {
    ...
    d.ChartCursor = d.Class({
        construct: function (a) {
            ...
            if (this.enabled) {
                ...
                this.fireMoved();
                if (r) {
                    var t = r.x[g.id], u = c.rotate, z = this.stepWidth, v = this.categoryBalloon, w = this.firstTime,
                        x = this.lastTime, A = this.cursorPosition,
                        B = this.zooming, D = this.panning, C = c.graphs;
                    if (c.mouseIsOver || B || D || this.forceShow) if (this.forceShow = !1, D) {
                        ...
                        w = this.line;
                        0 < this.cursorAlpha && (u ? (x = 0, z = t + l, e && (z -= g.cellWidth / 2)) : (x = t, z = 0, e && (x -= g.cellWidth / 2)), A = this.animationDuration, 0 < A && !this.zooming ?
                            isNaN(this.previousX) ? w.translate(x, z) : (w.translate(this.previousX, this.previousY), w.animate({translate: x + "," + z}, A, "easeOutSine")) : w.translate(x, z), this.previousX = x, this.previousY = z, w.show());
                        this.linePos = u ? t + l : t;
                        B && (e && w.hide(), u ? this.updateSelectionSize(NaN, t) : this.updateSelectionSize(t, NaN));
                        z = !0;
                        B && (z = !1);
                        this.categoryBalloonEnabled && z ? (this.setBalloonPosition(v, g, t, u), (w = this.categoryBalloonFunction) ? v.showBalloon(w(r.category)) : g.parseDates ? (g = d.formatDate(r.category, this.categoryBalloonDateFormat,
                            c), -1 != g.indexOf("fff") && (g = d.formatMilliseconds(g, r.category)), v.showBalloon(g)) : v.showBalloon(d.fixNewLines(r.category))) : v.hide();
                        ...
                        if (a != this.previousIndex || I != this.previousMostCloseGraph) if (this.normalizeBulletSize(),
                            ...
                            for (g = 0; g < C.length; g++) if (v = C[g], x = NaN, (!this.oneBalloonOnly || v == I) && v.showBalloon && !v.hidden && v.balloonText && ("step" == v.type && "left" == v.stepDirection && (r = this.data[a + 1]), r)) {
                                ...
                                if (this.showNextAvailable && isNaN(x) && a + 1 < this.data.length) for (z = a + 1; z < this.data.length; z++) if (e = this.data[z]) if (w = e.axes[v.valueAxis.id].graphs[v.id], x =
                                    w.y, !isNaN(x)) break;
                                if (!isNaN(x)) {
                                    e = w.x;
                                    l = !0;
                                    ...
                                    "horizontal" == D && (l.pointerOrientation = "H"), l.changeColor(A), void 0 !== v.balloonAlpha && (l.fillAlpha = v.balloonAlpha), void 0 !== v.balloonTextColor && (l.color = v.balloonTextColor), l.setPosition(z + m, e + n), z = c.formatString(v.balloonText, w, !0), (e = v.balloonFunction) && (z = e(w, v).toString()), "" !== z && (u ? l.showBalloon(z) : (l.text = z, l.show = !0), t.push({
                                        yy: x,
                                        balloon: l
                        ...
                        b ? (k = {type: "changed"}, k.index =
                            a, k.chart = this.chart, k.zooming = B, k.mostCloseGraph = I, k.position = u ? f : h, k.target = this, c.fire("changed", k), this.fire("changed", k), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
            ...
            if (a) {
                ...
                if (this.enabled && 0 < b.length) {
                    if (this.pan) this.rolledOver = !1; else if (this.zoomable && this.zooming) {
                        ...
                        (b[c.start] && (c.start = b[c.start].time), b[c.end] && (c.end = a.getEndTime(b[c.end].time))), this.skipZoomDispatch || this.fire(c.type, c)); else {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var t = this.horizontalPadding, u = this.verticalPadding, z = this.pointerWidth,
                        v = this.pointerOrientation, w = this.cornerRadius, x = c.fontFamily, A = this.fontSize;
...
(function () {
    ...
    d.AmRectangularChart = d.Class({
        inherits: d.AmCoordinateChart, construct: function (a) {
            ...
            this.dy =
                Math.round(-this.depth3D * Math.sin(this.angle * Math.PI / 180));
    ...
    d.TrendLine = d.Class({
        construct: function (a) {
            ...
            var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory,
                ...
                u = a.finalXValue, z = a.initialValue, v =
                    a.finalValue, w = p.recalculateToPercents, x = b.dataDateFormat;
...
(function () {
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p) {
        ...
        h >= z &&
        (h = z);
        var v = 1 / 180 * Math.PI, z = b + Math.sin(e * v) * k, w = c - Math.cos(e * v) * t,
            x = b + Math.sin(e * v) * f, A = c - Math.cos(e * v) * g, B = b + Math.sin((e + h) * v) * f,
            D = c - Math.cos((e + h) * v) * g, C = b + Math.sin((e + h) * v) * k, v = c - Math.cos((e + h) * v) * t,
    ...
    d.AmLegend = d.Class({
        construct: function (a) {
            ...
            if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a) "center" == this.align ? b =
                f + (n - w.width) / 2 : "right" == this.align && (b = f + n - w.width);
            z.translate(b, m + 1);
