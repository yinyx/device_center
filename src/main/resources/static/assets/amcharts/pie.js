    ...
    inherits: AmCharts.AmSlicedChart, construct: function (e) {
        ...
        if (AmCharts.ifArray(e)) {
            if (0 < this.realWidth && 0 < this.realHeight) {
                ...
                this.realHeight = h;
                var d = AmCharts.toCoordinate, k = d(this.marginLeft, b), a = d(this.marginRight, b),
                    t = d(this.marginTop, h) + this.getTitleHeight(), m = d(this.marginBottom, h), w, x, g,
                ...
                for (k = 0; k < e.length; k++) if (a = e[k], !0 !== a.hidden && 0 < a.percents) {
                    var n = 360 * a.percents / 100, q = Math.sin((m + n / 2) / 180 * Math.PI),
                        y = -Math.cos((m + n / 2) / 180 * Math.PI) * (b / g), p = this.outlineColor;
                    p || (p = a.color);
                    var z = this.alpha;
